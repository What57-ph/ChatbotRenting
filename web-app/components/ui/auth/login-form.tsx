...
export function LoginForm() {
  ...
  return (
    <div className="flex w-full items-center justify-center p-6 sm:p-8 bg-zinc-50 dark:bg-zinc-950">
      <Card className="w-full max-w-md border-0 shadow-xl bg-white dark:bg-zinc-900/50 backdrop-blur-sm">
        <CardHeader className="space-y-2 text-center pb-6">
          <div className="md:hidden flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-xl font-bold dark:text-white">Lumina AI</span>
          </div>
          <CardTitle className="text-3xl font-semibold tracking-tight dark:text-zinc-100">Welcome back</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="dark:border-zinc-800 dark:hover:bg-zinc-800 dark:text-zinc-300">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input 
                ...
                required
                className="h-11 dark:border-zinc-800 dark:bg-zinc-900 dark:text-white"
              />
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-medium text-indigo-500 hover:text-indigo-400 hover:underline">
                  Forgot password?
                </a>
              </div>
              <Input 
            ...
            <Button type="submit" className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white mt-2" disabled={loading}>
