...
2. Đọc `agent-progress.md` để biết trạng thái đã xác minh mới nhất và bước tiếp theo.
...
- `agent-progress.md`: nhật ký phiên và trạng thái đã xác minh hiện tại
...
- bằng chứng được ghi lại trong `feature_list.json` hoặc `agent-progress.md`
